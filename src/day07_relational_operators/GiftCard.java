 ...
 */
        ...
        double item2Price = 40;

        System.out.println("In my giftcard i have $" + giftCardBalance + "balance.");
        System.out.println("Buy item 1 for $" + item1Price+ "with your gift card");
        System.out.println("My gift card balance is "+ (giftCardBalance -= item1Price));
        System.out.println("Buy item 1 for $" + item2Price+ "with your gift card");
        System.out.println("My gift card balance is "+ (giftCardBalance -= item2Price));
